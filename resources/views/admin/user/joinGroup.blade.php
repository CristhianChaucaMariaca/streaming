                    ...
                    @foreach ($groups as $group)
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-footer"><a href="{{route('user-attach-group',[$user,$group->id])}}" class="btn btn-primary" title="Unir al grupo"><span class="material-icons">group_add</span></a></div>
                            </div>
                        </div>
                    @endforeach
                </div>

        ...
        <div class="col-md-8">
            <div class="card">
                        ...
                        <tbody>
                            @forelse ($user->groups as $group)
                                <tr>
                                    <td>{{ $group->id }}</td>
                                    <td>{{$group->name}}</td>
                                    <td width="1" class="table-active"><a href="{{route('user-detach-group',[$user,$group->id])}}" title="Salir del grupo" class="btn btn-danger"><span class="material-icons">group_remove</span></a></td>
                ...
                <div class="card-footer d-flex justify-content-between">
                    <a href="{{ route('user-edit',$user->id) }}" class="btn btn-warning" title="Editar usuario"><span class="material-icons">edit</span></a>
                    ...
                    <td class="table-active" width="1"><a href="#" class="btn btn-success" title="Pagos registrados"><span class="material-icons">payments</span></a></td>
                </div>
            </div>
        </div>
    </div>
